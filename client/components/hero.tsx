        ...
        <div className="w-full z-20 bg-white text-black p-4 sm:p-6 lg:p-6 grid place-content-center place-items-start order-2 lg:order-1">
          <span className="lg:translate-x-[20%] -translate-y-0 w-full">
            ...
            <h1 className="font-cabinet text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl 2xl:text-9xl font-bold mb-4 lg:mb-4 2xl:mb-6 leading-tight lg:leading-none">
              ...
              <span
                ref={textPerfectRef}
                className="translate-y-1 lg:translate-y-4 2xl:translate-y-6 overflow-hidden text-bordo inline-block rounded-xl backdrop-blur-xl backdrop-filter bg-opacity-10"
              >
                Perfection
              </span>{" "}
              <br /> Our Work of{" "}
              <span
                ref={textExRef}
                className="overflow-hidden translate-y-1 lg:translate-y-5 2xl:translate-y-8 text-bordo inline-block mb-1 rounded-xl backdrop-blur-xl backdrop-filter bg-opacity-10"
              >
                Excellence
              </span>
            </h1>
